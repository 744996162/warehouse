...
def main_lcd(channel):
    ...
    uid_left_list_2015Q1_2015Q1 = []

    for uid in uid_listQ1:
        if uid in channel_uid_set:
            uid_left_list_Q1_Q1.append(uid)

    for uid in uid_listQ2:
        if uid in channel_uid_set:
            uid_left_list_Q2_Q2.append(uid)

    for uid in uid_listQ3:
        if uid in channel_uid_set:
            uid_left_list_Q3_Q3.append(uid)

    for uid in uid_listQ4:
        if uid in channel_uid_set:
            uid_left_list_Q4_Q4.append(uid)

    for uid in uid_list2015Q1:
        if uid in channel_uid_set:
            uid_left_list_2015Q1_2015Q1.append(uid)

    for uid in uid_listQ2:
        if uid in uid_setQ1 and (uid in channel_uid_set):
    ...
    for uid in uid_listQ3:
        if uid in uid_setQ2 and (uid in channel_uid_set):
    ...
    for uid in uid_listQ4:
        if uid in uid_setQ3 and (uid in channel_uid_set):
    ...
    for uid in uid_list2015Q1:
        if uid in uid_setQ4 and (uid in channel_uid_set):
            uid_left_list_Q4_2015Q1.append(uid)


    # out_file_path = "data/gt_consumers_lcd.dat"

    out_file_path = "data/" + channel + "_gt_consumers_lcd.dat"
    out_file = open(out_file_path, "a")

    out_file.write("Q1" + "\t" + "Q1" + "\t" + str(len(set(uid_left_list_Q1_Q1))) + "\t" + str(len(uid_left_list_Q1_Q1)) + "\n")
    ...
    out_file.write("Q2" + "\t" + "Q2" + "\t" + str(len(set(uid_left_list_Q2_Q2))) + "\t" + str(len(uid_left_list_Q2_Q2)) + "\n")
    ...
    out_file.write("Q3" + "\t" + "Q3" + "\t" + str(len(set(uid_left_list_Q3_Q3))) + "\t" + str(len(uid_left_list_Q3_Q3)) + "\n")
    ...
    out_file.write("Q4" + "\t" + "Q4" + "\t" + str(len(set(uid_left_list_Q4_Q4))) + "\t" + str(len(uid_left_list_Q4_Q4)) + "\n")
    out_file.write("Q4" + "\t" + "2015Q1" + "\t" + str(len(set(uid_left_list_Q4_2015Q1))) + "\t" + str(len(uid_left_list_Q4_2015Q1)) + "\n")

    out_file.write("2015Q1" + "\t" + "2015Q1" + "\t" + str(len(set(uid_left_list_2015Q1_2015Q1))) + "\t" + str(len(uid_left_list_2015Q1_2015Q1)) + "\n")
