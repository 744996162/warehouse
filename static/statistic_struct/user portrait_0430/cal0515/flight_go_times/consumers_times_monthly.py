...
if __name__ == "__main__":
    main_hb_go_times("20140101", "20140201", "month01.data")
    main_hb_go_times("20140201", "20140301", "month02.data")
    main_hb_go_times("20140301", "20140401", "month03.data")
    main_hb_go_times("20140401", "20140501", "month04.data")
    main_hb_go_times("20140501", "20140601", "month05.data")
    main_hb_go_times("20140601", "20140701", "month06.data")
    main_hb_go_times("20140701", "20140801", "month07.data")
    main_hb_go_times("20140801", "20140901", "month08.data")
    main_hb_go_times("20140901", "20141001", "month09.data")
    main_hb_go_times("20141001", "20141101", "month10.data")
    main_hb_go_times("20141101", "20141201", "month11.data")
    main_hb_go_times("20141201", "20150101", "month12.data")
    pass