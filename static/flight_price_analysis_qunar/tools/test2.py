...
def test():
    url="http://search.rsscc.cn/flight/domestic?src=ctrip&org=TSN&dst=HRB&date=2015-03-04"
...
def getDataFromUrl():
    url="http://search.rsscc.cn/flight/domestic?src=ctrip&org=BJS&dst=SHA&date=2015-02-08"
    json_str=getJson(url)
    print(json_str)
    test_all(json_str)
    pass
