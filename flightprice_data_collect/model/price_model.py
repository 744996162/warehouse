...
class PriceModel(object):
    ...
    def printstr(self):
        string_out1="fn:"+str(self.fn)+","+"org:"+str(self.org)+","+"dst:"+str(self.dst)+","+"departcode:"+str(self.departureairportcode)+","+"arrcode:"+str(self.arrivingairportcode)
        string_out2="flydate:"+str(self.flydate)+","+"leastprice:"+str(self.leastprice)+","+"cabin:"+str(self.cabin)
