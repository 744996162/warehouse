...
file_name_list = ["new_fileab","new_fileac","new_filead","new_fileae","new_fileaf","new_fileag",
                  "new_fileah","new_fileai","new_fileaj","new_fileak","new_fileal","new_fileam","new_filean",
                  "new_fileao","new_fileap","new_fileaq","new_filear","new_fileas","new_fileat",
                  "new_fileau"]
...
for file_name in file_name_list:
    file_in_linux_path = base_path + file_name
    # print(file_in_linux_path)
    ...
    for (count, line) in enumerate(file_in):
        ...
        if count % 10000 == 0 or (count == (file_lines-1)):
            # print dict_list
            print (file_in_linux_path,str(count))
