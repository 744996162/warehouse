...
class QueryOrdersDao(GtOrderDao):
    def __init__(self, dbtype="gtgj102"):
...
def OrderOutTest():
    date_list = getdata(start_date="20140105", end_date="20140825", deata=3)
...
def OrderSubOutTest():
    date_list = getdata(start_date="20130601", end_date="20130613", deata=15)
    for date_arr in date_list:
        s_day = date_arr[0]
        end_day = date_arr[1]
        print(s_day, end_day)
