...
class QueryOrdersDao(object):
    def __init__(self, dbtype="gtgj102", DaoClass=GtOrderDao):
        self.dbdao =DaoClass(dbtype=dbtype)
        self.tablename = 'user_order_history_20140825'
        self.out_base_path = '/home/huolibi/data/gt_order_all/ordernew/'
...
class QueryOrdersSubDao(object):
    def __init__(self, dbtype="gtgj102", DaoClass=GtOrderSubDao, out_base_path=""):
        self.dbdao = DaoClass(dbtype=dbtype)
        self.tablename = 'user_sub_order_history_20140825'
        if out_base_path == "":
            self.out_base_path = 'G:/data/gt_order_all/'
...
def OrderOutTest():
    date_list = getdata(start_date="20130701", end_date="20140826", deata=3)
